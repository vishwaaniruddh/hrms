                ...
                <div className="container-fluid">
                    <div className="nk-header-wrap">
                        <div className="nk-menu-trigger d-xl-none ms-n1"><a href="#"
                            className="nk-nav-toggle nk-quick-nav-icon" aria-label="Toggle Navigation Menu" data-target="sidebarMenu"><em
                        ...
                        <div className="nk-header-tools">
                            <ul className="nk-quick-nav">
                                ...
                                <li className="dropdown chats-dropdown hide-mb-xs"><a href="#"
                                    className="dropdown-toggle nk-quick-nav-icon" aria-label="Recent Chats" data-bs-toggle="dropdown">
                                ...
                                <li className="dropdown notification-dropdown"><a href="#"
                                    className="dropdown-toggle nk-quick-nav-icon" aria-label="Notifications" data-bs-toggle="dropdown">
                                ...
                                <li className="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#"
                                    className="dropdown-toggle nk-quick-nav-icon" aria-label="Select Language" data-bs-toggle="dropdown">
                                ...
                                <li className="dropdown user-dropdown"><a href="#" className="dropdown-toggle me-n1"
                                    aria-label="User Profile Menu" data-bs-toggle="dropdown">
