                        ...
                        <div className="nk-header-tools">
                            <ul className="nk-quick-nav">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                        ...
                                        <div className="dropdown-body">
                                            <ul className="chat-list">
                                                ...
                                                <li className="chat-item"><a className="chat-link" href="apps-chats.html">
                                                    <div className="chat-media user-avatar">{/* ⚡ Bolt: Added loading="lazy" to below-the-fold avatar image to improve frontend performance */}
                                                    <img
                                ...
                                <li className="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#"
                                    className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                    <div className="quick-icon border border-light">{/* ⚡ Bolt: Added loading="lazy" to below-the-fold icon image to improve frontend performance */}
                                    <img className="icon"
                                        src={english_sq} alt="" loading="lazy" /></div>
                                </a>
                                    <div className="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                                        <ul className="language-list">
                                            <li><a href="#" className="language-item">{/* ⚡ Bolt: Added loading="lazy" to below-the-fold flag image to improve frontend performance */}
                                                <img
                                                src={english} alt=""
                                            ...
                                            <li><a href="#" className="language-item">
                                                {/* ⚡ Bolt: Added loading="lazy" to below-the-fold flag image to improve frontend performance */}
                                                <img src={turkey}
