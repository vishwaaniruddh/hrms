                ...
                <div className="container-fluid">
                    <div className="nk-header-wrap">
                        <div className="nk-menu-trigger d-xl-none ms-n1"><a href="#"
                            aria-label="Toggle sidebar navigation" className="nk-nav-toggle nk-quick-nav-icon" data-target="sidebarMenu"><em
                        ...
                        <div className="nk-header-tools">
                            <ul className="nk-quick-nav">
                                ...
                                <li className="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#" aria-label="Change language"
                                    className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                ...
                                <li className="dropdown user-dropdown"><a href="#" aria-label="User menu" className="dropdown-toggle me-n1"
