            ...
            <div className="nk-header nk-header-fixed nk-header-fluid">
                <div className="container-fluid">
                    <div className="nk-header-wrap">
                        <div className="nk-menu-trigger d-xl-none ms-n1"><a href="#" aria-label="Toggle Navigation"
                        ...
                        <div className="nk-header-search ms-3 ms-xl-0 d-none d-md-flex"><em
                            className="icon ni ni-search"></em><input type="text" aria-label="Search anything"
                                className="form-control border-transparent form-focus-none"
                                placeholder="Search anything" /></div>
                        <div className="nk-header-tools">
                            <ul className="nk-quick-nav">
                                <li className="nav-item"><a data-bs-toggle="modal" href="#region" aria-label="Region Settings"
                                    className="nk-quick-nav-icon"><em className="icon ni ni-globe"></em></a></li>
                                <li className="dropdown chats-dropdown hide-mb-xs"><a href="#" aria-label="Recent Chats"
                                ...
                                <li className="dropdown notification-dropdown"><a href="#" aria-label="Notifications"
                                    className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                ...
                                <li className="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#" aria-label="Language Selection"
                                    className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                    <div className="quick-icon border border-light"><img className="icon"
                                        src={english_sq} alt="Current language" /></div>
                                </a>
                                ...
                                <li className="dropdown user-dropdown"><a href="#" className="dropdown-toggle me-n1" aria-label="User Menu"
