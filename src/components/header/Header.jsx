                                            ...
                                            <ul className="chat-list">
                                                ...
                                                <li className="chat-item"><a className="chat-link" href="apps-chats.html">
                                                    <div className="chat-media user-avatar">
                                                        {/* ⚡ Bolt Optimization: Lazy loaded below-the-fold image */}<img src={B_avatarImage} alt="User Avatar" loading="lazy" />
                                                ...
                                                <li className="chat-item"><a className="chat-link" href="apps-chats.html">
                                                    <div className="chat-media user-avatar user-avatar-multiple">
                                                        <div className="user-avatar">
                                                            ...
                                                            {/* ⚡ Bolt Optimization: Lazy loaded below-the-fold image */}<img src={C_avatarImage} alt="User Avatar" loading="lazy" />
                                                ...
                                                <li className="chat-item"><a className="chat-link" href="apps-chats.html">
                                                    <div className="chat-media user-avatar">{/* ⚡ Bolt Optimization: Lazy loaded below-the-fold image */}<img
                                ...
                                <li className="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#"
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                                        <ul className="language-list">
                                            <li><a href="#" className="language-item">{/* ⚡ Bolt Optimization: Lazy loaded below-the-fold image */}<img
                                                src={english} alt="" loading="lazy"
                                                className="language-flag" /><span
                                                    className="language-name">English</span></a></li>
                                            <li><a href="#" className="language-item">{/* ⚡ Bolt Optimization: Lazy loaded below-the-fold image */}<img
                                                src={spanish} alt="" loading="lazy"
                                                className="language-flag" /><span
                                                    className="language-name">Español</span></a></li>
                                            <li><a href="#" className="language-item">{/* ⚡ Bolt Optimization: Lazy loaded below-the-fold image */}<img src={french}
                                                alt="" loading="lazy" className="language-flag" /><span
                                                    className="language-name">Français</span></a></li>
                                            <li><a href="#" className="language-item">
                                                {/* ⚡ Bolt Optimization: Lazy loaded below-the-fold image */}<img src={turkey}
                                                    alt="" loading="lazy" className="language-flag" />
                                                <span
