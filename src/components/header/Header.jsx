                ...
                <div className="container-fluid">
                    <div className="nk-header-wrap">
                        <div className="nk-menu-trigger d-xl-none ms-n1"><a href="#"
                            aria-label="Toggle menu" className="nk-nav-toggle nk-quick-nav-icon" data-target="sidebarMenu"><em
                        ...
                        <div className="nk-header-tools">
                            <ul className="nk-quick-nav">
                                <li className="nav-item"><a data-bs-toggle="modal" href="#region"
                                    aria-label="Select region" className="nk-quick-nav-icon"><em className="icon ni ni-globe"></em></a></li>
                                <li className="dropdown chats-dropdown hide-mb-xs"><a href="#"
                                    aria-label="Open chats" className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                ...
                                <li className="dropdown notification-dropdown"><a href="#"
                                    aria-label="Open notifications" className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
