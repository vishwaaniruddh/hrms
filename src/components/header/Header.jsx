                        ...
                        <div className="nk-header-tools">
                            <ul className="nk-quick-nav">
                                            ...
                                            <ul className="chat-list">
                                                ...
                                                <li className="chat-item"><a className="chat-link" href="apps-chats.html">
                                                    <div className="chat-media user-avatar">
                                                        {/* ⚡ Bolt Optimization: Added lazy loading to below-the-fold image */}
                                                ...
                                                <li className="chat-item"><a className="chat-link" href="apps-chats.html">
                                                    <div className="chat-media user-avatar">{/* ⚡ Bolt Optimization: Added lazy loading to below-the-fold image */}
                                                    <img loading="lazy"
                                ...
                                <li className="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#"
                                    className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                    <div className="quick-icon border border-light">{/* ⚡ Bolt Optimization: Added lazy loading to below-the-fold image */}
                                    <img loading="lazy" className="icon"
                                        src={english_sq} alt="" /></div>
                                </a>
                                    <div className="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                                        <ul className="language-list">
                                            <li><a href="#" className="language-item">{/* ⚡ Bolt Optimization: Added lazy loading to below-the-fold image */}
                                            <img loading="lazy"
                                                src={english} alt=""
