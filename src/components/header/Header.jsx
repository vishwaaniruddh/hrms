                                            ...
                                            <ul className="chat-list">
                                                ...
                                                <li className="chat-item"><a className="chat-link" href="apps-chats.html">
                                                    <div className="chat-media user-avatar">
                                                        {/* ⚡ Bolt Optimization: Lazy load below-the-fold avatar image in dropdown */}
                                                ...
                                                <li className="chat-item"><a className="chat-link" href="apps-chats.html">
                                                    <div className="chat-media user-avatar">{/* ⚡ Bolt Optimization: Lazy load below-the-fold avatar image in dropdown */}
                                                        <img
                                ...
                                <li className="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#"
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                                        <ul className="language-list">
                                            <li><a href="#" className="language-item">{/* ⚡ Bolt Optimization: Lazy load below-the-fold language flag image in dropdown */}
                                                <img
                                                src={english} alt=""
                                            ...
                                            <li><a href="#" className="language-item">
                                                {/* ⚡ Bolt Optimization: Lazy load below-the-fold language flag image in dropdown */}
                                                <img src={turkey}
