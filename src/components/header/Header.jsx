                                ...
                                <li className="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#"
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                                        <ul className="language-list">
                                            <li><a href="#" className="language-item"><img src={english} alt="" className="language-flag" loading="lazy" /><span
                                                    className="language-name">English</span></a></li>
                                            <li><a href="#" className="language-item"><img src={spanish} alt="" className="language-flag" loading="lazy" /><span
                                                    className="language-name">Español</span></a></li>
                                            <li><a href="#" className="language-item"><img src={french} alt="" className="language-flag" loading="lazy" /><span
                                                    className="language-name">Français</span></a></li>
                                            <li><a href="#" className="language-item">
                                                <img src={turkey} alt="" className="language-flag" loading="lazy" />
                                                <span
