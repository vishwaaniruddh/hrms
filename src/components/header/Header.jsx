                        ...
                        <div className="nk-header-tools">
                            <ul className="nk-quick-nav">
                                ...
                                <li className="dropdown chats-dropdown hide-mb-xs"><a href="#"
                                    className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown" aria-label="View chats">
                                ...
                                <li className="dropdown notification-dropdown"><a href="#"
                                    className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown" aria-label="View notifications">
                                ...
                                <li className="dropdown user-dropdown"><a href="#" className="dropdown-toggle me-n1"
                                    data-bs-toggle="dropdown" aria-label="User profile options">
