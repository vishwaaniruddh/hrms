                                    ...
                                    <div class="card-inner position-relative card-tools-toggle">
                                       <div class="card-title-group">
                                          ...
                                          <div class="card-search search-wrap" data-search="search">
                                             <div class="card-body">
                                                <div class="search-content"><a href="#" class="search-back btn btn-icon toggle-search" aria-label="Close search" data-target="search"><em class="icon ni ni-arrow-left"></em></a><input type="text" class="form-control border-transparent form-focus-none" placeholder="Search by name" aria-label="Search by name" /><button class="search-submit btn btn-icon" aria-label="Submit search"><em class="icon ni ni-search"></em></button></div>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
