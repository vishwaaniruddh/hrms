                  ...
                  <ul class="nk-quick-nav">
                     <li class="dropdown chats-dropdown hide-mb-xs">
                        ...
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                           ...
                           <div class="dropdown-foot center"><a href="/demo7/pharmacy/support.html">View All</a></div>
                        </div>
                     </li>
                     ...
                     <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                           ...
                           <div class="dropdown-inner">
                              <ul class="link-list">
                                 <li><a href="/demo7/pharmacy/members-profile-regular.html"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
                                 <li><a href="/demo7/pharmacy/general-settings.html"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li>
                                 <li><a href="/demo7/pharmacy/account-log.html"><em class="icon ni ni-activity-alt"></em><span>Login Activity</span></a></li>
                              </ul>
                           </div>
                           <div class="dropdown-inner">
                              <ul class="link-list">
                              ...
                              <div class="card-inner">
                                 <form action="#">
                                    <div class="row gy-4">
                                       ...
                                       <div class="col-xxl-3 col-sm-6">
                                          <div class="form-group"><label class="form-label" for="salary">Total Salary</label><input type="number" class="form-control" id="salary" placeholder="Salary" required="" /></div>
                                       </div>
                                       <div class="col-xxl-3 col-sm-6">
                                          <div class="form-group"><label class="form-label" for="days">Working Days</label><input type="number" class="form-control" id="days" placeholder="Working Days" required="" /></div>
                                       </div>
                                       <div class="col-12">
                                          <div class="form-group">
                                             <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                                <li><button type="submit" class="btn btn-primary ">Save Informations</button></li>
                                                <li><button data-bs-dismiss="modal" class="btn btn-danger">Cancel</button></li>
                                             </ul>
                                          </div>
                                       </div>
                                    </div>
                                       ...
                                       <div class="card-title-group">
                                          ...
                                          <div class="card-tools me-n1">
                                             <ul class="btn-toolbar gx-1">
                                                {/* 🎨 Palette: Added aria-label for accessibility on icon-only search toggle */}
                                                <li><a href="#" aria-label="Toggle search" class="btn btn-icon search-toggle toggle-search" data-target="search"><em class="icon ni ni-search"></em></a></li>
                                             </ul>
                                          </div>
                                          <div class="card-search search-wrap" data-search="search">
                                             <div class="card-body">
                                                <div class="search-content">
                                                   {/* 🎨 Palette: Added aria-labels for accessibility on icon-only search buttons */}
                                                   <a href="#" aria-label="Close search" class="search-back btn btn-icon toggle-search" data-target="search"><em class="icon ni ni-arrow-left"></em></a>
                                                   <input type="text" class="form-control border-transparent form-focus-none" placeholder="Search by name" />
                                                   <button aria-label="Submit search" class="search-submit btn btn-icon"><em class="icon ni ni-search"></em></button>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="nk-tb-list nk-tb-ulist">
                                          <div class="nk-tb-item nk-tb-head  bg-lighter">
                                             ...
                                             <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1 my-n1">
                                                   <li>
                                                      <div class="drodown">
                                                         {/* 🎨 Palette: Added aria-label for accessibility on icon-only bulk actions dropdown */}
                                                         <a href="#" aria-label="Bulk actions" class="dropdown-toggle btn btn-icon btn-trigger me-n1" data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
                                          ...
                                          <div class="nk-tb-item">
                                             <div class="nk-tb-col">
                                                <a href="#">
                                                   <div class="user-card">
                                                      <div class="user-info"><span class="tb-lead">Emma Walker</span></div>
                                                   </div>
                                                </a>
                                             </div>
                                             <div class="nk-tb-col tb-col-sm"><span>12/12/2021</span></div>
                                             <div class="nk-tb-col"><span class="tb-amount">7800.00 <span class="currency">USD</span></span></div>
                                             <div class="nk-tb-col tb-col-md"><span class="badge bg-danger">22Days</span></div>
                                             <div class="nk-tb-col tb-col-lg"><span>Manager</span></div>
                                             <div class="nk-tb-col tb-col-md"><span class="tb-status text-danger">Unpaid</span></div>
                                             <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                   <li>
                                                      <div class="drodown">
                                                         {/* 🎨 Palette: Added aria-label for accessibility on icon-only row actions dropdown */}
                                                         <a href="#" aria-label="Row actions" class="dropdown-toggle btn btn-icon btn-trigger" data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
                                                         <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                       ...
                                       <div class="nk-block-between-md g-3">
                                          ...
                                          <div class="g">
                                             <div class="pagination-goto d-flex justify-content-center justify-content-md-start gx-3">
                                                <div>Page</div>
                                                <div>
                                                   <select class="form-select form-select-sm js-select2 select2-hidden-accessible" data-search="on" data-dropdown="xs center" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                                   ...
                                                   <span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style={{width: '80.6424px'}}><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-plpd-container"><span class="select2-selection__rendered" id="select2-plpd-container" role="textbox" aria-readonly="true" title="1">1</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                </div>
                                                <div>OF 102</div>
                                             </div>
                                          </div>
