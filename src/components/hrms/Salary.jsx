                        ...
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                           ...
                           <div class="dropdown-body">
                              <ul class="chat-list">
                                 ...
                                 <li class="chat-item">
                                    <a class="chat-link" href="/demo7/pharmacy/support.html">
                                       <div class="chat-media user-avatar">{/* ⚡ Bolt Optimization: Added lazy loading to below-the-fold image */}<img loading="lazy" src="/demo7/images/avatar/b-sm.jpg" alt="" /></div>
                                       <div class="chat-info">
                                          <div class="chat-from">
                                 ...
                                 <li class="chat-item">
                                    <a class="chat-link" href="/demo7/pharmacy/support.html">
                                       <div class="chat-media user-avatar user-avatar-multiple">
                                          <div class="user-avatar">{/* ⚡ Bolt Optimization: Added lazy loading to below-the-fold image */}<img loading="lazy" src="/demo7/images/avatar/c-sm.jpg" alt="" /></div>
                                 ...
                                 <li class="chat-item">
                                    <a class="chat-link" href="/demo7/pharmacy/support.html">
                                       <div class="chat-media user-avatar">{/* ⚡ Bolt Optimization: Added lazy loading to below-the-fold image */}<img loading="lazy" src="/demo7/images/avatar/a-sm.jpg" alt="" /><span class="status dot dot-lg dot-success"></span></div>
                                       <div class="chat-info">
                                          <div class="chat-from">
