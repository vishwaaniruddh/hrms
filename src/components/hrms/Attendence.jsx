                                ...
                                <div className="nk-block-head nk-block-head-sm">
                                    <div className="nk-block-between">
                                        <div className="nk-block-head-content">
                                            <h3 className="nk-block-title page-title">Attendence</h3>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="row gy-5">
                                        <div className="col-lg-12">
                                            <div className="nk-block-head">
                                                <div className="nk-block-head-content">
                                                    <h5 className="nk-block-title title">Add an attendence</h5>
                                                </div>
                                            </div>
                                                        ...
                                                        <div className="row gy-4">
                                                            ...
                                                            <div className="col-xxl-4 col-sm-6">
                                                                <div className="form-group">
                                                                    ...
                                                                    <div className="form-control-wrap has-timepicker"><input type="text" className="form-control time-picker" placeholder="06.00 AM" /></div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="nk-block-head">
                                                <div className="nk-block-head-content">
                                                    <h5 className="nk-block-title title">Attendence List</h5>
                                                </div>
                                            </div>
                                            <div className="nk-block">
                                                        ...
                                                        <div className="card-inner p-0">
                                                            <div className="nk-tb-list nk-tb-ulist">
                                                                <div className="nk-tb-item nk-tb-head  bg-lighter">
                                                                    ...
                                                                    <div className="nk-tb-col tb-col-md"><span className="sub-text">Sign In</span></div>
                                                                    <div className="nk-tb-col tb-col-md"><span className="sub-text">Sign Out</span></div>
                                                                    <div className="nk-tb-col"><span className="sub-text">Stay Time</span></div>
                                                                                ...
                                                                                <div className="drodown">
                                                                                    ...
                                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                                        <ul className="link-list-opt no-bdr">
                                                                                            <li><a data-bs-toggle="modal" href="#editAttendence"><em className="icon ni ni-edit"></em><span>Edit Selected</span></a></li>
                                                                ...
                                                                <div className="nk-tb-item">
                                                                    <div className="nk-tb-col">
                                                                        <a href="#">
                                                                            <div className="user-card">
                                                                                <div className="user-info"><span className="tb-lead">Abu Bin Ishtiyak</span></div>
                                                                            </div>
                                                                        </a>
                                                                    </div>
                                                                    <div className="nk-tb-col tb-col-sm"><span>19/12/2020</span></div>
                                                                    <div className="nk-tb-col tb-col-md"><span>09:00 am</span></div>
                                                                    <div className="nk-tb-col tb-col-md"><span>06:00 am</span></div>
                                                                    <div className="nk-tb-col"><span className="badge badge-dim bg-danger">9hr 0min</span></div>
                                                                    <div className="nk-tb-col nk-tb-col-tools">
                                                                        <ul className="nk-tb-actions gx-1">
                                                                            <li>
                                                                                <div className="drodown">
                                                                                    ...
                                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                                        <ul className="link-list-opt no-bdr">
                                                                                            <li><a data-bs-toggle="modal" href="#editAttendence"><em className="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                ...
                                                                <div className="g">
                                                                    <div className="pagination-goto d-flex justify-content-center justify-content-md-start gx-3">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style={{width: '80px'}}><span className="selection"><span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex="0" aria-disabled="false" aria-labelledby="select2-sxhd-container"><span className="select2-selection__rendered" id="select2-sxhd-container" role="textbox" aria-readonly="true" title="1">1</span><span className="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span className="dropdown-wrapper" aria-hidden="true"></span></span>
                                                                        </div>
                                                                        <div>OF 102</div>
                                                                    </div>
                                                                </div>
