                                                        ...
                                                        <div class="row gy-4">
                                                            ...
                                                            <div class="col-xxl-4 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap has-timepicker"><input type="text" class="form-control time-picker" placeholder="06.00 AM" /></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="nk-tb-list nk-tb-ulist">
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col">
                                                                        <a href="#">
                                                                            <div class="user-card">
                                                                                <div class="user-info"><span class="tb-lead">Abu Bin Ishtiyak</span></div>
                                                                            </div>
                                                                        </a>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-sm"><span>19/12/2020</span></div>
                                                                    <div class="nk-tb-col tb-col-md"><span>09:00 am</span></div>
                                                                    <div class="nk-tb-col tb-col-md"><span>06:00 am</span></div>
                                                                    <div class="nk-tb-col"><span class="badge badge-dim bg-danger">9hr 0min</span></div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                ...
                                                                <div class="g">
                                                                    <div class="pagination-goto d-flex justify-content-center justify-content-md-start gx-3">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style={{width: '80px'}}><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-sxhd-container"><span class="select2-selection__rendered" id="select2-sxhd-container" role="textbox" aria-readonly="true" title="1">1</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                                        </div>
                                                                        <div>OF 102</div>
                                                                    </div>
                                                                </div>
