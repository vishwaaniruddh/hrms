                                                            ...
                                                            <div class="card-title-group">
                                                                ...
                                                                <div class="card-tools me-n1">
                                                                    <ul class="btn-toolbar gx-1">
                                                                        <li>{/* 🎨 Palette: Added aria-label for accessibility */}
<a href="#" class="btn btn-icon search-toggle toggle-search" data-target="search" aria-label="Toggle search"><em class="icon ni ni-search"></em></a></li>
                                                                    </ul>
                                                                </div>
                                                                <div class="card-search search-wrap" data-search="search">
                                                                    <div class="card-body">
                                                                        <div class="search-content">{/* 🎨 Palette: Added aria-label for accessibility */}
<a href="#" class="search-back btn btn-icon toggle-search" data-target="search" aria-label="Close search"><em class="icon ni ni-arrow-left"></em></a><input type="text" class="form-control border-transparent form-focus-none" placeholder="Search by name" />{/* 🎨 Palette: Added aria-label for accessibility */}
<button class="search-submit btn btn-icon" aria-label="Submit search"><em class="icon ni ni-search"></em></button></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="nk-tb-item nk-tb-head  bg-lighter">
                                                                    ...
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1 my-n1">
                                                                            <li>
                                                                                <div class="drodown">
                                                                                    {/* 🎨 Palette: Added aria-label for accessibility */}
