    ...
    <div>
      ...
      <div className="page-header">
        ...
        <div className="page-actions" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <button className="btn btn-outline" onClick={loadActiveData} title="Refresh Live Metrics" aria-label="Refresh Live Metrics">
                      ...
                      <td style={{ textAlign: 'right', whiteSpace: 'nowrap' }}>
                        <div style={{ display: 'inline-flex', gap: '0.4rem', alignItems: 'center' }}>
                          ...
                          <button
                            ...
                            aria-label="View Full Appraisal Scorecard" onClick={() => setViewScorecardModal(rev)}
                          >
                            Scorecard
                          </button>
                          ...
                          {!isEmployee && rev.status === 'Finalized' && !rev.payroll_increment_applied && (
                            <button
                              ...
                              aria-label="Sync approved increment directly to payroll" onClick={() => handleApplyIncrement(rev)}
                            >
                              <DollarSign size={12} />
                              <span>Sync Pay</span>
                            </button>
