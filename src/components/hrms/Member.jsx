                              ...
                              <div className="card-title-group">
                                 <div className="card-tools">
                                    <div className="form-inline flex-nowrap gx-3">
                                       ...
                                       <div className="btn-wrap"><span className="d-none d-md-block"><button className="btn btn-dim btn-outline-light disabled">Apply</button></span><span className="d-md-none"><button className="btn btn-dim btn-outline-light btn-icon disabled" aria-label="Next step"><em className="icon ni ni-arrow-right"></em></button></span></div>
                                    </div>
                                 </div>
                                    ...
                                    <ul className="btn-toolbar gx-1">
                                       ...
                                       <li>
                                          <div className="toggle-wrap">
                                             <a href="#" className="btn btn-icon btn-trigger toggle" data-target="cardTools" aria-label="Toggle card tools"><em className="icon ni ni-menu-right"></em></a>
                                             <div className="toggle-content" data-content="cardTools">
                                                <ul className="btn-toolbar gx-1">
                                                   <li className="toggle-close"><a href="#" className="btn btn-icon btn-trigger toggle" data-target="cardTools" aria-label="Toggle card tools"><em className="icon ni ni-arrow-left"></em></a></li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <div className="dropdown">
                                                         <a href="#" className="btn btn-trigger btn-icon dropdown-toggle" data-bs-toggle="dropdown" aria-label="Settings">
                                                               <em className="icon ni ni-setting"></em></a>
