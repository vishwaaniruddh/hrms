                                                ...
                                                <ul className="btn-toolbar gx-1">
                                                   ...
                                                   <li>
                                                      <div className="dropdown">
                                                         <a href="#" className="btn btn-trigger btn-icon dropdown-toggle" data-bs-toggle="dropdown" aria-label="More Options">
                                                         ...
                                                         <div className="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                            <div className="dropdown-head">
                                                               ...
                                                               <div className="dropdown"><a href="#" className="btn btn-sm btn-icon" aria-label="More Filters Options"><em className="icon ni ni-more-h"></em></a></div>
                                                            </div>
                                                   ...
                                                   <li>
                                                      <div className="dropdown">
                                                         <a href="#" className="btn btn-trigger btn-icon dropdown-toggle" data-bs-toggle="dropdown" aria-label="More Options"><em className="icon ni ni-setting"></em></a>
                                       ...
                                       <ul className="nk-tb-actions gx-1 my-n1">
                                          <li>
                                             <div className="drodown">
                                                <a href="#" className="dropdown-toggle btn btn-icon btn-trigger me-n1" data-bs-toggle="dropdown" aria-label="More Action Options"><em className="icon ni ni-more-h"></em></a>
                                 ...
                                 <div className="nk-tb-item">
                                    ...
                                    <div className="nk-tb-col nk-tb-col-tools">
                                       <ul className="nk-tb-actions gx-1">
                                          ...
                                          <li>
                                             <div className="drodown">
                                                <a href="#" className="dropdown-toggle btn btn-icon btn-trigger" data-bs-toggle="dropdown" aria-label="More Action Options"><em className="icon ni ni-more-h"></em></a>
                                                <div className="dropdown-menu dropdown-menu-end">
                                                   <ul className="link-list-opt no-bdr">
