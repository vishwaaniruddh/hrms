                           ...
                           <div className="card-inner position-relative card-tools-toggle">
                              ...
                              <div className="card-search search-wrap" data-search="search">
                                 <div className="card-body">
                                    ...
                                    <input type="text" aria-label="Search by Member name or email" className="form-control border-transparent form-focus-none" placeholder="Search by Member name or email" /><button aria-label="Submit search" className="search-submit btn btn-icon"><em className="icon ni ni-search"></em></button></div>
                                 </div>
                              </div>
                           </div>
