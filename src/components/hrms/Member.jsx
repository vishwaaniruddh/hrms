                           ...
                           <div className="card-inner position-relative card-tools-toggle">
                              ...
                              <div className="card-search search-wrap" data-search="search">
                                 <div className="card-body">
                                    <div className="search-content"><a href="#" className="search-back btn btn-icon toggle-search" data-target="search" aria-label="Back from Search"><em className="icon ni ni-arrow-left"></em></a>
