                           ...
                           <div className="card-inner position-relative card-tools-toggle">
                                    ...
                                    <ul className="btn-toolbar gx-1">
                                       ...
                                       <li>
                                          <div className="toggle-wrap">
                                             <a href="#" className="btn btn-icon btn-trigger toggle" data-target="cardTools" aria-label="Toggle options"><em className="icon ni ni-menu-right"></em></a>
                                             <div className="toggle-content" data-content="cardTools">
                                                <ul className="btn-toolbar gx-1">
                                                   <li className="toggle-close"><a href="#" className="btn btn-icon btn-trigger toggle" data-target="cardTools" aria-label="Close options"><em className="icon ni ni-arrow-left"></em></a></li>
                                                   <li>
                                                      <div className="dropdown">
                                                         ...
                                                         <div className="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                            <div className="dropdown-head">
                                                               ...
                                                               <div className="dropdown"><a href="#" className="btn btn-sm btn-icon" aria-label="More filter options"><em className="icon ni ni-more-h"></em></a></div>
                                                            </div>
                              ...
                              <div className="card-search search-wrap" data-search="search">
                                 <div className="card-body">
                                    <div className="search-content"><a href="#" className="search-back btn btn-icon toggle-search" data-target="search" aria-label="Close search"><em className="icon ni ni-arrow-left"></em></a>
                                       ...
                                       <ul className="nk-tb-actions gx-1 my-n1">
                                          <li>
                                             <div className="drodown">
                                                <a href="#" className="dropdown-toggle btn btn-icon btn-trigger me-n1" data-bs-toggle="dropdown" aria-label="More actions"><em className="icon ni ni-more-h"></em></a>
                                 ...
                                 <div className="nk-tb-item">
                                    ...
                                    <div className="nk-tb-col nk-tb-col-tools">
                                       <ul className="nk-tb-actions gx-1">
                                          ...
                                          <li>
                                             <div className="drodown">
                                                <a href="#" className="dropdown-toggle btn btn-icon btn-trigger" data-bs-toggle="dropdown" aria-label="More actions"><em className="icon ni ni-more-h"></em></a>
                                                <div className="dropdown-menu dropdown-menu-end">
                                                   <ul className="link-list-opt no-bdr">
