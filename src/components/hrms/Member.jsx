                           ...
                           <div className="card-inner position-relative card-tools-toggle">
                              <div className="card-title-group">
                                 ...
                                 <div className="card-tools me-n1">
                                    <ul className="btn-toolbar gx-1">
                                       <li>{/* 🎨 Palette: Added aria-label to icon-only toggle button */}<a href="#" aria-label="Toggle search" className="btn btn-icon search-toggle toggle-search" data-target="search"><em className="icon ni ni-search"></em></a></li>
                              ...
                              <div className="card-search search-wrap" data-search="search">
                                 <div className="card-body">
                                    <div className="search-content">{/* 🎨 Palette: Added aria-label to icon-only back button */}<a href="#" aria-label="Close search" className="search-back btn btn-icon toggle-search" data-target="search"><em className="icon ni ni-arrow-left"></em></a>
                                    <input type="text" className="form-control border-transparent form-focus-none" placeholder="Search by Member name or email" />{/* 🎨 Palette: Added aria-label to icon-only search button for accessibility */}<button aria-label="Submit search" className="search-submit btn btn-icon"><em className="icon ni ni-search"></em></button></div>
                                 </div>
                              </div>
                           </div>
