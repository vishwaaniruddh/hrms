                           ...
                           <div className="card-inner position-relative card-tools-toggle">
                              <div className="card-title-group">
                                 <div className="card-tools">
                                    <div className="form-inline flex-nowrap gx-3">
                                       ...
                                       <div className="btn-wrap"><span className="d-none d-md-block"><button className="btn btn-dim btn-outline-light disabled">Apply</button></span><span className="d-md-none"><button className="btn btn-dim btn-outline-light btn-icon disabled" aria-label="Apply filters"><em className="icon ni ni-arrow-right"></em></button></span></div>
                                    </div>
                                 </div>
                                    ...
                                    <ul className="btn-toolbar gx-1">
                                       ...
                                       <li>
                                          <div className="toggle-wrap">
                                             <a href="#" className="btn btn-icon btn-trigger toggle" aria-label="Toggle menu" data-target="cardTools"><em className="icon ni ni-menu-right"></em></a>
                                             <div className="toggle-content" data-content="cardTools">
                                                <ul className="btn-toolbar gx-1">
                                                   <li className="toggle-close"><a href="#" className="btn btn-icon btn-trigger toggle" aria-label="Toggle menu" data-target="cardTools"><em className="icon ni ni-arrow-left"></em></a></li>
                                                   <li>
                                                      <div className="dropdown">
                                                         <a href="#" className="btn btn-trigger btn-icon dropdown-toggle" aria-label="More options" data-bs-toggle="dropdown">
                                                   ...
                                                   <li>
                                                      <div className="dropdown">
                                                         <a href="#" className="btn btn-trigger btn-icon dropdown-toggle" aria-label="More options" data-bs-toggle="dropdown"><em className="icon ni ni-setting"></em></a>
                              ...
                              <div className="card-search search-wrap" data-search="search">
                                 <div className="card-body">
                                    <div className="search-content"><a href="#" className="search-back btn btn-icon toggle-search" aria-label="Back to search" data-target="search"><em className="icon ni ni-arrow-left"></em></a>
                                 ...
                                 <div className="nk-tb-item">
                                    ...
                                    <div className="nk-tb-col nk-tb-col-tools">
                                       <ul className="nk-tb-actions gx-1">
                                          ...
                                          <li>
                                             <div className="drodown">
                                                <a href="#" className="dropdown-toggle btn btn-icon btn-trigger" aria-label="More options" data-bs-toggle="dropdown"><em className="icon ni ni-more-h"></em></a>
                                                <div className="dropdown-menu dropdown-menu-end">
                                                   <ul className="link-list-opt no-bdr">
