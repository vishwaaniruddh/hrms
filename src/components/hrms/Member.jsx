                              ...
                              <div className="card-title-group">
                                 ...
                                 <div className="card-tools me-n1">
                                    <ul className="btn-toolbar gx-1">
                                       <li><a href="#" aria-label="Search" className="btn btn-icon search-toggle toggle-search" data-target="search"><em className="icon ni ni-search"></em></a></li>
                                       <li className="btn-toolbar-sep"></li>
                                       <li>
                                          <div className="toggle-wrap">
                                             <a href="#" aria-label="Toggle Menu" className="btn btn-icon btn-trigger toggle" data-target="cardTools"><em className="icon ni ni-menu-right"></em></a>
                                                ...
                                                <ul className="btn-toolbar gx-1">
                                                   ...
                                                   <li>
                                                      <div className="dropdown">
                                                         <a href="#" aria-label="More Options" className="btn btn-trigger btn-icon dropdown-toggle" data-bs-toggle="dropdown">
