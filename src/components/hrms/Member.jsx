                                                ...
                                                <ul className="btn-toolbar gx-1">
                                                   ...
                                                   <li>
                                                      <div className="dropdown">
                                                         <a href="#" className="btn btn-trigger btn-icon dropdown-toggle" aria-label="Open Dropdown" data-bs-toggle="dropdown">
                                                   ...
                                                   <li>
                                                      <div className="dropdown">
                                                         <a href="#" className="btn btn-trigger btn-icon dropdown-toggle" aria-label="Open Dropdown" data-bs-toggle="dropdown"><em className="icon ni ni-setting"></em></a>
