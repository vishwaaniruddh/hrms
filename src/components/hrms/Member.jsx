                           ...
                           <div className="card-inner position-relative card-tools-toggle">
                              <div className="card-title-group">
                                 ...
                                 <div className="card-tools me-n1">
                                    <ul className="btn-toolbar gx-1">
                                       <li><a href="#" aria-label="Search Members" className="btn btn-icon search-toggle toggle-search" data-target="search"><em className="icon ni ni-search"></em></a></li>
                                                ...
                                                <ul className="btn-toolbar gx-1">
                                                   ...
                                                   <li>
                                                      <div className="dropdown">
                                                         <a href="#" aria-label="Filter Members" className="btn btn-trigger btn-icon dropdown-toggle" data-bs-toggle="dropdown">
                              ...
                              <div className="card-search search-wrap" data-search="search">
                                 <div className="card-body">
                                    <div className="search-content"><a href="#" aria-label="Back" className="search-back btn btn-icon toggle-search" data-target="search"><em className="icon ni ni-arrow-left"></em></a>
                                 ...
                                 <div className="nk-tb-item">
                                    ...
                                    <div className="nk-tb-col nk-tb-col-tools">
                                       <ul className="nk-tb-actions gx-1">
                                          ...
                                          <li>
                                             <div className="drodown">
                                                <a href="#" aria-label="More Options" className="dropdown-toggle btn btn-icon btn-trigger" data-bs-toggle="dropdown"><em className="icon ni ni-more-h"></em></a>
                                                <div className="dropdown-menu dropdown-menu-end">
                                                   <ul className="link-list-opt no-bdr">
