                                                ...
                                                <div className="nk-block-head nk-block-head-lg">
                                                    <div className="nk-block-between">
                                                        ...
                                                        <div className="nk-block-head-content align-self-start d-lg-none">
                                                            {/* 🎨 Palette: Added aria-label for accessibility on icon-only menu toggle */}
                                                            <a href="#" aria-label="Toggle user menu" className="toggle btn btn-icon btn-trigger mt-n1" data-target="userAside"><em className="icon ni ni-menu-alt-r"></em></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="nk-block">
                                                                            ...
                                                                            <div className="user-card">
                                                                                ...
                                                                                <div className="user-action">
                                                                                    <div className="dropdown">
                                                                                        {/* 🎨 Palette: Added aria-label for accessibility on icon-only dropdown button */}
                                                                                        <a aria-label="More options" className="btn btn-icon btn-trigger me-n2" data-bs-toggle="dropdown" href="#"><em className="icon ni ni-more-v"></em></a>
