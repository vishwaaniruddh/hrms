                                            ...
                                            <div className="card-inner card-inner-lg">
                                                <div className="nk-block-head nk-block-head-lg">
                                                    <div className="nk-block-between">
                                                        ...
                                                        {/* 🎨 Palette: Added ARIA label to icon-only button for better screen reader accessibility */}
                                                        <div className="nk-block-head-content align-self-start d-lg-none"><a href="#" aria-label="Toggle user menu" className="toggle btn btn-icon btn-trigger mt-n1" data-target="userAside"><em className="icon ni ni-menu-alt-r"></em></a></div>
                                                    </div>
                                                </div>
                                                <div className="nk-block">
                                                                            ...
                                                                            <div className="user-card">
                                                                                ...
                                                                                <div className="user-action">
                                                                                    <div className="dropdown">
                                                                                        {/* 🎨 Palette: Added ARIA label to icon-only button for better screen reader accessibility */}
                                                                                        <a className="btn btn-icon btn-trigger me-n2" aria-label="More options" data-bs-toggle="dropdown" href="#"><em className="icon ni ni-more-v"></em></a>
