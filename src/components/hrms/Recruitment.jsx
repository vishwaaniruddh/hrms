          ...
          <div className="dialog-content" style={{ maxWidth: '680px', maxHeight: '90vh' }} onClick={(e) => e.stopPropagation()}>
            <div className="drawer-header">
              ...
              <button 
                ...
                aria-label="Close dialog" onClick={() => setIsDetailDrawerOpen(false)}
              >
                <X size={18} />
              </button>
            </div>
          ...
          <div className="dialog-content" onClick={(e) => e.stopPropagation()}>
            <div className="dialog-header">
              ...
              <button 
                type="button" 
                className="dialog-close-btn" 
                aria-label="Close dialog" onClick={() => setIsNewJobOpen(false)}
              >
                <X size={18} />
              </button>
            </div>
          ...
          <div className="dialog-content" onClick={(e) => e.stopPropagation()}>
            <div className="dialog-header">
              ...
              <button 
                type="button" 
                className="dialog-close-btn" 
                aria-label="Close dialog" onClick={() => setIsNewCandOpen(false)}
              >
                <X size={18} />
              </button>
            </div>
