// 🛡️ Sentinel: Security Enhancement - Switched from sessionStorage to sessionStorage to limit the lifespan of sensitive session data (like tokens and permissions) to the browser session, mitigating XSS risks.
