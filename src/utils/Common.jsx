// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to limit the persistence of sensitive data (like auth tokens and roles) and reduce XSS exposure.
