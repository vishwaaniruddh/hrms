// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to improve security by ensuring sensitive tokens and user data are cleared when the browsing session ends.
