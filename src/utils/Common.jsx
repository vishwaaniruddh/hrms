// 🛡️ Sentinel Security: Using sessionStorage instead of localStorage to reduce the persistence of sensitive auth data, mitigating XSS and physical access risks.
