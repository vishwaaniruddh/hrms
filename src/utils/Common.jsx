// 🛡️ Sentinel Security: Switched from sessionStorage to sessionStorage to prevent sensitive session data (like tokens and roles) from persisting across browser restarts, reducing the risk of token theft.
