...
// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to prevent tokens and user roles from persisting beyond the active browser session.
...
// 🛡️ Sentinel Security: Clearing all session variables on logout to prevent privilege escalation or data leakage.
