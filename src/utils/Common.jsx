// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to limit exposure of sensitive auth tokens to the window session, mitigating persistent XSS theft risks.
