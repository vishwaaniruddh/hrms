// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to prevent persistent storage of sensitive tokens across browser sessions, reducing XSS impact.
