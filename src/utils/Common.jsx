// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to ensure sensitive data (auth tokens, user roles) is automatically cleared when the browser window/tab is closed.
