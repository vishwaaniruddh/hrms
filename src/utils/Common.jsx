// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to prevent sensitive tokens and user data from persisting across browser sessions, reducing exposure to XSS.
