// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to limit the lifespan of sensitive tokens and user data to the browser session, mitigating XSS risks.
