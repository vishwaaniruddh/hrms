// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to prevent sensitive session data from persisting indefinitely and to mitigate XSS risks.
