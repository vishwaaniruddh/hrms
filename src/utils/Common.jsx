// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to limit the lifetime of sensitive data (like tokens) to the session window, mitigating persistent XSS risks.
