// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage across this utility to prevent persistent cross-session leakage of authentication tokens and sensitive user roles.
