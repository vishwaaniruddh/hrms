// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage for sensitive data like tokens and roles to reduce risk of persistent token theft via XSS.
