// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to prevent XSS attacks from extracting persistent sensitive authentication tokens across sessions.
