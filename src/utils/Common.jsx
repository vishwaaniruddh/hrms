// 🛡️ Sentinel Security: Replaced localStorage with sessionStorage to ensure sensitive tokens and user roles do not persist across browser sessions, reducing the risk of XSS attacks stealing persistent credentials.
