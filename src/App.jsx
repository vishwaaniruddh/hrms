...
const HomePage = () => {
    return (
        <Router>
            <MainLayout />
            {/* ⚡ Bolt Optimization: Implemented route-level code splitting using React.lazy and Suspense.
                This reduces the initial bundle size by loading route components only when they are needed. */}
