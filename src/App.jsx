...
// ⚡ Bolt Optimization: Lazy load route components to reduce initial bundle size and improve page load performance
...
const HomePage = () => {
    return (
        <Router>
            <MainLayout />
            {/* ⚡ Bolt Optimization: Wrap routes in Suspense to handle lazy loading states */}
