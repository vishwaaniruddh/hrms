...
// Bolt Optimization: Code splitting main route components to reduce initial bundle size
...
const HomePage = () => {
    return (
        <Router>
            <MainLayout />
            {/* Bolt Optimization: Suspense boundary to show fallback UI while downloading route chunks */}
