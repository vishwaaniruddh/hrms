...
// ⚡ Bolt: Adding code splitting for route components to reduce initial bundle size and improve load times
// Impact: Defers loading of heavy route components until they are actually navigated to.
