...
// ⚡ Bolt Optimization: Lazy load route components to reduce initial bundle size and speed up page load.
...
const HomePage = () => {
    return (
        <Router>
            <MainLayout />
            {/* ⚡ Bolt Optimization: Suspense boundary for lazy loaded route components */}
