...
// Converted heavy route components to dynamic imports using React.lazy().
// This enables code splitting, ensuring the initial JS bundle remains small
// and child routes are only loaded when navigated to, reducing initial load time.
