...
// ⚡ Bolt Performance Optimization: Lazy load route components to reduce initial bundle size and speed up page load.
...
const HomePage = () => {
    return (
        <Router>
            <MainLayout />
            {/* ⚡ Bolt Performance Optimization: Suspense boundary for lazy loaded components to improve initial paint time */}
