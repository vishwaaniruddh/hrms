...
// ⚡ Bolt: Code splitting route components to reduce initial bundle size and improve load times.
// Each route is now lazily loaded, meaning its JS chunk is only fetched when the user navigates to it.
