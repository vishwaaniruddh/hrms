...
// ⚡ Bolt Optimization: Using React.lazy for route-level code splitting to reduce initial bundle size and improve load time.
...
const HomePage = () => {
    return (
        <Router>
            <MainLayout />
            {/* ⚡ Bolt Optimization: Suspense boundary to show loading state while lazy-loaded components are fetched */}
